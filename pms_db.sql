...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 19, 2021 at 06:25 PM
...
CREATE TABLE IF NOT EXISTS `parking_slots` (
  ...
  `ent_exi` int(1) NOT NULL DEFAULT '0',
...
INSERT INTO `parking_slots` (`parking_slot`, `status`, `email`, `slot_status`, `ent_exi`) VALUES
(1, 'Inactive', '', 0, 0),
(2, 'Inactive', '', 0, 0),
(3, 'Inactive', '', 0, 0),
(4, 'Inactive', '', 0, 0),
...
('1', 'admin', 'myparkbotpms@gmail.com', 1, '81dc9bdb52d04dc20036dbd8313ed055', 1, NULL, NULL, NULL, '');
COMMIT;
